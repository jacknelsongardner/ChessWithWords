...
import { Organization } from "../../../../data/api/admin/v1alpha/organization.js";
...
(function (AuditLogEventType) {
    ...
    AuditLogEventType[AuditLogEventType["ORGANIZATION_UPDATE"] = 6] = "ORGANIZATION_UPDATE";
...
export function auditLogEventTypeFromJSON(object) {
    switch (object) {
        ...
        case "ORGANIZATION_UPDATE":
            return AuditLogEventType.ORGANIZATION_UPDATE;
        case -1:
        case "UNRECOGNIZED":
        default:
...
export function auditLogEventTypeToJSON(object) {
    switch (object) {
        ...
        case AuditLogEventType.ORGANIZATION_DELETE:
            return 5;
        case AuditLogEventType.ORGANIZATION_UPDATE:
            return 6;
...
function createBaseAuditLogEvent() {
    return {
        ...
        organizationDeletePayload: undefined,
        organizationUpdatePayload: undefined,
        username: "",
    };
}
export const AuditLogEvent = {
    ...
    encode(message, writer = _m0.Writer.create()) {
        ...
        if (message.organizationDeletePayload !== undefined) {
            OrganizationDeleteAuditLogEventPayload.encode(message.organizationDeletePayload, writer.uint32(106).fork())
                .ldelim();
        }
        if (message.organizationUpdatePayload !== undefined) {
            OrganizationUpdateAuditLogEventPayload.encode(message.organizationUpdatePayload, writer.uint32(114).fork())
                .ldelim();
        }
        if (message.username !== "") {
        ...
        while (reader.pos < end) {
            ...
            switch (tag >>> 3) {
                ...
                case 13:
                    ...
                    message.organizationDeletePayload = OrganizationDeleteAuditLogEventPayload.decode(reader, reader.uint32());
                    continue;
                case 14:
                    if (tag !== 114) {
                        break;
                    }
                    message.organizationUpdatePayload = OrganizationUpdateAuditLogEventPayload.decode(reader, reader.uint32());
                    continue;
                case 11:
                    if (tag !== 90) {
                        break;
    ...
    fromJSON(object) {
        return {
            ...
            dataSubscriptionDeletePayload: isSet(object.dataSubscriptionDeletePayload)
                ...
                : undefined,
            organizationDeletePayload: isSet(object.organizationDeletePayload)
                ? OrganizationDeleteAuditLogEventPayload.fromJSON(object.organizationDeletePayload)
                : undefined,
            organizationUpdatePayload: isSet(object.organizationUpdatePayload)
                ? OrganizationUpdateAuditLogEventPayload.fromJSON(object.organizationUpdatePayload)
                : undefined,
    ...
    toJSON(message) {
        ...
        if (message.organizationDeletePayload !== undefined) {
            obj.organizationDeletePayload = OrganizationDeleteAuditLogEventPayload.toJSON(message.organizationDeletePayload);
        }
        if (message.organizationUpdatePayload !== undefined) {
            obj.organizationUpdatePayload = OrganizationUpdateAuditLogEventPayload.toJSON(message.organizationUpdatePayload);
        }
        if (message.username !== "") {
    ...
    fromPartial(object) {
        ...
        message.dataSubscriptionDeletePayload =
            (object.dataSubscriptionDeletePayload !== undefined && object.dataSubscriptionDeletePayload !== null)
                ...
                : undefined;
        message.organizationDeletePayload =
            (object.organizationDeletePayload !== undefined && object.organizationDeletePayload !== null)
                ? OrganizationDeleteAuditLogEventPayload.fromPartial(object.organizationDeletePayload)
                : undefined;
        message.organizationUpdatePayload =
            (object.organizationUpdatePayload !== undefined && object.organizationUpdatePayload !== null)
                ? OrganizationUpdateAuditLogEventPayload.fromPartial(object.organizationUpdatePayload)
                : undefined;
...
function createBaseOrganizationDeleteAuditLogEventPayload() {
    return { organization: undefined };
}
export const OrganizationDeleteAuditLogEventPayload = {
    $type: "devvit.dev_portal.data_api.admin.audit.OrganizationDeleteAuditLogEventPayload",
    encode(message, writer = _m0.Writer.create()) {
    ...
    decode(input, length) {
        const reader = input instanceof _m0.Reader ? input : _m0.Reader.create(input);
        let end = length === undefined ? reader.len : reader.pos + length;
        const message = createBaseOrganizationDeleteAuditLogEventPayload();
        while (reader.pos < end) {
            const tag = reader.uint32();
            switch (tag >>> 3) {
                case 1:
    ...
    create(base) {
        return OrganizationDeleteAuditLogEventPayload.fromPartial(base ?? {});
    },
    fromPartial(object) {
        const message = createBaseOrganizationDeleteAuditLogEventPayload();
...
messageTypeRegistry.set(OrganizationDeleteAuditLogEventPayload.$type, OrganizationDeleteAuditLogEventPayload);
function createBaseOrganizationUpdateAuditLogEventPayload() {
    return { organization: undefined };
}
export const OrganizationUpdateAuditLogEventPayload = {
    $type: "devvit.dev_portal.data_api.admin.audit.OrganizationUpdateAuditLogEventPayload",
    encode(message, writer = _m0.Writer.create()) {
        if (message.organization !== undefined) {
            Organization.encode(message.organization, writer.uint32(10).fork()).ldelim();
        }
    ...
    decode(input, length) {
        const reader = input instanceof _m0.Reader ? input : _m0.Reader.create(input);
        let end = length === undefined ? reader.len : reader.pos + length;
        const message = createBaseOrganizationUpdateAuditLogEventPayload();
        while (reader.pos < end) {
            const tag = reader.uint32();
            switch (tag >>> 3) {
                case 1:
    ...
    create(base) {
        return OrganizationUpdateAuditLogEventPayload.fromPartial(base ?? {});
    },
    fromPartial(object) {
        const message = createBaseOrganizationUpdateAuditLogEventPayload();
        message.organization = (object.organization !== undefined && object.organization !== null)
...
messageTypeRegistry.set(OrganizationUpdateAuditLogEventPayload.$type, OrganizationUpdateAuditLogEventPayload);
