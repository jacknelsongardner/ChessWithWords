...
export interface OrganizationDeleteAuditLogEventPayload {
    organization?: Organization | undefined;
}
export interface OrganizationUpdateAuditLogEventPayload {
    organization?: Organization | undefined;
}
...
export declare const OrganizationDeleteAuditLogEventPayload: {
    $type: "devvit.dev_portal.data_api.admin.audit.OrganizationDeleteAuditLogEventPayload";
    encode(message: OrganizationDeleteAuditLogEventPayload, writer?: _m0.Writer): _m0.Writer;
    decode(input: _m0.Reader | Uint8Array, length?: number): OrganizationDeleteAuditLogEventPayload;
    fromJSON(object: any): OrganizationDeleteAuditLogEventPayload;
    toJSON(message: OrganizationDeleteAuditLogEventPayload): unknown;
    create(base?: DeepPartial<OrganizationDeleteAuditLogEventPayload>): OrganizationDeleteAuditLogEventPayload;
    fromPartial(object: DeepPartial<OrganizationDeleteAuditLogEventPayload>): OrganizationDeleteAuditLogEventPayload;
};
export declare const OrganizationUpdateAuditLogEventPayload: {
    $type: "devvit.dev_portal.data_api.admin.audit.OrganizationUpdateAuditLogEventPayload";
    encode(message: OrganizationUpdateAuditLogEventPayload, writer?: _m0.Writer): _m0.Writer;
    decode(input: _m0.Reader | Uint8Array, length?: number): OrganizationUpdateAuditLogEventPayload;
    fromJSON(object: any): OrganizationUpdateAuditLogEventPayload;
    toJSON(message: OrganizationUpdateAuditLogEventPayload): unknown;
    create(base?: DeepPartial<OrganizationUpdateAuditLogEventPayload>): OrganizationUpdateAuditLogEventPayload;
    fromPartial(object: DeepPartial<OrganizationUpdateAuditLogEventPayload>): OrganizationUpdateAuditLogEventPayload;
};
