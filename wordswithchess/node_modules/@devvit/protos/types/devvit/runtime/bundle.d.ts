...
export declare const Permissions: {
    $type: "devvit.runtime.Permissions";
...
export declare const ServerBundle: {
    ...
    create(base?: DeepPartial<ServerBundle>): ServerBundle;
    fromPartial(object: DeepPartial<ServerBundle>): ServerBundle;
};
